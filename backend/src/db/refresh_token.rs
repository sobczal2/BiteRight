...
use sqlx::query;
use crate::models::query_objects::refresh_token::{CreateRefreshTokenQuery, FetchRefreshTokenQueryResult};
...
pub async fn find_refresh_token_by_user_id(conn: &mut PgConnection, user_id: i32) -> Result<Option<FetchRefreshTokenQueryResult>, sqlx::Error>
{
    let result = query_as!(
        FetchRefreshTokenQueryResult,
        r#"
