...
public class CurrencyConfiguration : IEntityTypeConfiguration<BiteRight.Domain.Currencies.Currency>
{
    public void Configure(
        EntityTypeBuilder<BiteRight.Domain.Currencies.Currency> builder
    )
    {
    ...
    private static IEnumerable<BiteRight.Domain.Currencies.Currency> GetSeedData()
    {
        yield return PLN;
        yield return GBP;
        yield return EUR;
    ...
    public static BiteRight.Domain.Currencies.Currency PLN { get; } = BiteRight.Domain.Currencies.Currency.Create(
    ...
    // ReSharper disable once InconsistentNaming
    public static BiteRight.Domain.Currencies.Currency GBP { get; } = BiteRight.Domain.Currencies.Currency.Create(
    ...
    // ReSharper disable once InconsistentNaming
    public static BiteRight.Domain.Currencies.Currency EUR { get; } = BiteRight.Domain.Currencies.Currency.Create(
        Name.Create("Euro"),
        Symbol.Create("€"),
    ...
    // ReSharper disable once InconsistentNaming
    public static BiteRight.Domain.Currencies.Currency USD { get; } = BiteRight.Domain.Currencies.Currency.Create(
